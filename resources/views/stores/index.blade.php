                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <button class="btn btn-primary" tabindex="0" aria-controls="example1" type="button"><span>Cadastrar Nova</span>
                                    </button>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                    ...
                                    <tbody>
                                        <tr class="even">
                                            <td class="sorting_1 dtr-control">Ponto Quente</td>
                                            <td>pontoquente@gmail.com</td>
                                            <td>(98) 98200-0000</td>
                                            <td>R$ 500,00</td>
                                            <td>25%</td>
                                            <td>Ativa</td>
                                            <td>Desconto - Sorteio</td>
                                            <td>
                                                Editar - Excluir
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th rowspan="1" colspan="1">Situação atual</th>
